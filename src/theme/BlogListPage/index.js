          ...
          <div className="bloghome__intro">
            <animated.div style={animatedTexts[0]} className="hero_text">
              ...
              <span className="intro__name">
                <Translate description="my name">潜心专研前端的Peyton</Translate>
              </span>
            </animated.div>
            ...
            <SocialLinks animatedProps={animatedTexts[2]} />
...
function SocialLinks({ animatedProps, ...props }) {
  ...
  return (
    <animated.div className="social__links" style={animatedProps}>
      ...
      <a href="https://github.com/fanpengsmile">
      ...
      <div className="dropdown dropdown--hoverable">
        ...
        <img
          ...
          src='https://dscache.tencent-cloud.cn/upload/uploader/we-4f06f0a6fc80e3525b86ee98ba541ab782718af6.jpg'//{useBaseUrl("/img/publicQR.webp")}
        />
      </div>
    </animated.div>
  );
